...
export function CartPage() {
  ...
  return (
    <div className="page shell">
      <div className="page-heading"><div><span className="eyebrow">Your bag</span><h1>Multi-vendor cart</h1><p>{cart.data.itemCount} items from {cart.data.groups.length} producers</p></div><button className="text-button" type="button" onClick={() => void cart.refetch()}><RefreshCw size={16} /> Refresh prices & stock</button></div>
